 ...
 */
final class Version20220321102317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE decision (id INT AUTO_INCREMENT NOT NULL, reunion_id INT DEFAULT NULL, adherent_id INT DEFAULT NULL, statut VARCHAR(255) NOT NULL, detail LONGTEXT NOT NULL, INDEX IDX_84ACBE484E9B7368 (reunion_id), INDEX IDX_84ACBE4825F06C53 (adherent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reunion (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, listemembre LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE decision ADD CONSTRAINT FK_84ACBE484E9B7368 FOREIGN KEY (reunion_id) REFERENCES reunion (id)');
        $this->addSql('ALTER TABLE decision ADD CONSTRAINT FK_84ACBE4825F06C53 FOREIGN KEY (adherent_id) REFERENCES adherent (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE decision DROP FOREIGN KEY FK_84ACBE484E9B7368');
